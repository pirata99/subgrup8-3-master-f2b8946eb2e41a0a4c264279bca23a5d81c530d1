...
public class Regles{
    ...
    //creadores
    public Regles(String nomReglesA){
        nomRegles = nomReglesA;
        assignacions = new ArrayList<>();
        frequencia = 0.0;
        confiansa = 0.0;
    }
    public Regles(String nomReglesA, ArrayList<Assignacio> assigs){
        nomRegles = nomReglesA;
        assignacions = assigs;
        frequencia = 0.0;
        confiansa = 0.0;
    }
    public Regles(String nomReglesA, ArrayList<Assignacio> assigs, Double freq, Double confi){
        nomRegles = nomReglesA;
        assignacions = assigs;
        frequencia = freq;
        confiansa = confi;
